...
export default function Features() {
  ...
  return (
    <section className="mt-8" id="features">
      <h2 className="m-0 mb-1 text-2xl md:text-3xl font-extrabold text-slate-900">Why FitMate</h2>
      <p className="mb-4 text-sm text-slate-600">Built as a clean baseline for secure, role-aware fitness workflows.</p>
